...
export const useStore = create<AppStore>((set, get) => ({
  ...
  visibleModules: { markets: true, weather: true, seismic: true, services: true, livecams: true, flights: true, political: true, seriea: true, events: true, fuel: true, 'protezione-civile': true },
